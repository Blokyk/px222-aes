module TestCipherInternals(testCipherInternals) where
...
testAddRoundKey
    = newTest "AddRoundKey" [
           (
            addRoundKey (map wordFromInt [0x2b7e1516, 0x28aed2a6, 0xabf71588, 0x09cf4f3c]) (map wordFromInt [0x3243f6a8, 0x885a308d, 0x313198a2, 0xe0370734]),
            map wordFromInt [0x193de3be, 0xa0f4e22b, 0x9ac68d2a, 0xe9f84808]
        ), (
            addRoundKey (map wordFromInt [0xef44a541, 0xa8525b7f, 0xb671253b, 0xdb0bad00]) (map wordFromInt [0x0fd6daa9, 0x603138bf, 0x6fc0106b, 0x5eb31301]),
            map wordFromInt [0xe0927fe8, 0xc86363c0, 0xd9b13550, 0x85b8be01]
        )
    ]

testNextKey :: HasCallStack => IO Bool
testNextKey
    = newTest "Key Derivation" [
           (
            keyAfterN 1 key128,
            nextKey128
        ), (
    ...
    where
        keyAfterN n key = foldl keyAfter key [0..(n-1)]
        key128 = map wordFromInt      [0x2b7e1516, 0x28aed2a6, 0xabf71588, 0x09cf4f3c]
        nextKey128 = map wordFromInt  [0xa0fafe17, 0x88542cb1, 0x23a33939, 0x2a6c7605]
        finalKey128 = map wordFromInt [0xd014f9a8, 0xc9ee2589, 0xe13f0cc8, 0xb6630ca6]

        key192 = map wordFromInt      [0x8e73b0f7, 0xda0e6452, 0xc810f32b, 0x809079e5, 0x62f8ead2, 0x522c6b7b]
        nextKey192 = map wordFromInt  [0xfe0c91f7, 0x2402f5a5, 0xec12068e, 0x6c827f6b, 0x0e7a95b9, 0x5c56fec2]
        finalKey192 = map wordFromInt [0x821f750a, 0xad07d753, 0xca400538, 0x8fcc5006, 0x282d166a, 0xbc3ce7b5]

        key256 = map wordFromInt      [0x603deb10, 0x15ca71be, 0x2b73aef0, 0x857d7781, 0x1f352c07, 0x3b6108d7, 0x2d9810a3, 0x0914dff4]
        nextKey256 = map wordFromInt  [0x9ba35411, 0x8e6925af, 0xa51a8b5f, 0x2067fcde, 0xa8b09c1a, 0x93d194cd, 0xbe49846e, 0xb75d5b9a]
        finalKey256 = map wordFromInt [0x749c47ab, 0x18501dda, 0xe2757e4f, 0x7401905a, 0xcafaaae3, 0xe4d59b34, 0x9adf6ace, 0xbd10190d]
